...
$config = array(
     ...
     */
    //'secretsalt' => 'izgfavg7ucyxhk28j89j37sj2rds92xx',
    // see platform.sh settings below
     ...
     */
    'technicalcontact_name'     => 'UBC IT Web Services',
    'technicalcontact_email'    => 'UBCIT.WebServices@ubc.ca',
    ...
    'database.password' => 'notusingthedefaultsecret',
    ...
    'authproc.sp' => array(
        ...
        20 => array(
            'class' => 'core:AttributeMap', 'ubc2name'
        ),
...
// Set SimpleSAML to use the metadata and cert directories in Git, rather than
...
if (isset($_ENV['PLATFORM_RELATIONSHIPS'])) {
  ...
  foreach ($relationships['database'] as $instance) {
    if (!empty($instance['query']['is_master'])) {
      ...
      $config['auth.adminpassword'] =  $instance['password'];
    }
  }
}

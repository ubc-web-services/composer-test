...
$metadata['https://authentication.ubc.ca'] = array (
  ...
  array (
    ...
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => 'https://authentication.ubc.ca/idp/profile/SAML2/Redirect/SLO',
    ),
    1 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST',
      'Location' => 'https://authentication.ubc.ca/idp/profile/SAML2/POST/SLO',
    ),
    2 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST-SimpleSign',
      'Location' => 'https://authentication.ubc.ca/idp/profile/SAML2/POST-SimpleSign/SLO',
    ),
  ),
